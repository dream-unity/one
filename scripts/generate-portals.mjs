...
<noscript><p class="note">Turn on JavaScript for the interactive activities. <a href="${home}">Return to Dream Unity</a>.</p></noscript></main><script type="module" src="${assets}app.js?v=portals-20260909"></script></body></html>\n`;
}
