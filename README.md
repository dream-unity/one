...
The original artwork becomes a living 3D ink-and-bronze symbol. A shared breathing rhythm expands and relaxes the whole body, a soft double pulse travels through its centre, and paired rings counter-rotate and flex together. Fine ink surfaces ripple while brass particles circulate in opposite pairs. The central portal stays fixed at the screen centre; the two side portals move symmetrically. Drag to tilt the symbol, scroll or pinch to zoom, and use Pause or Reset view. The paper texture remains the original Breath Journal background.
